        ...
        options: {
            ...
            handler: async (request) => {
                ...
                try {
                    ...
                    const newPlates = await csvData.map(async plate => {
                    ...
                    //const newPlates = await Plates.query().insertAndFetch(newPlates);

                    // Promise.all(newPlates).then(result => {
